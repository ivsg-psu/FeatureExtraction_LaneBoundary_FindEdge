function unit_vectors = fcn_findEdge_calcUnitVector(input_vectors, varargin)
%% findEdge_calcUnitVector
% Finds the unit vectors associated with a list of input vectors
%
% Format: 
% unit_vectors = findEdge_calcUnitVector(input_vectors, (fig_num))
%
% INPUTS:
...
% EXAMPLES:
%      
% See the script: script_test_fcn_findEdge_calcUnitVector
