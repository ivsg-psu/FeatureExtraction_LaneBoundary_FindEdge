function [angle_btw_unit_normals_and_vertical, ...
    mean_angle_btw_unit_normals_and_vertical_driven_path, ... 
    angle_btw_unit_normals_and_vertical_driven_path] = fcn_findEdge_determineAngleDeviation(LiDAR_allPoints, gridIndices_cell_array, original_qualified_grids, gridCenters_qualified_grids,current_qualified_grids,gridCenters_driven_path, grid_AABBs, grid_size, gridIndices, current_grid_numbers_of_driven_path, varargin)
