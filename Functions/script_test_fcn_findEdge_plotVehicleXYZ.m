% script_test_fcn_findEdge_plotVehicleXYZ
% Exercises the function: fcn_findEdge_plotVehicleXYZ
...
scanLineRange = [];
fcn_findEdge_plotVehicleXYZ(VehiclePose,(scanLineRange), ([]))
...
%% Test 3: call function with specific scan lines
fig_num = 3;
figure(fig_num);
clf;
